...
public class GestionarUsuarios extends javax.swing.JFrame {
    ...
    public GestionarUsuarios() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(""
                    + "select ide_usuario, nombre_usuario, username, tipo_nivel, estatus from usuarios");
            ...
            System.err.println("Error al llenal la Tabla " + e);
        ...
        public void mouseClicked(MouseEvent e){
            ...
            if (fila_point > -1) {
                user_update = (String)model.getValueAt(fila_point, columa_point);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Walpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 330));
