...
public class RestaurarPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_RestaurarPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 210, 35));
    ...
    private void jButton_RestaurarPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RestaurarPasswordActionPerformed
        ...
        Pass2 = txt_passwordConfirmacion.getText().trim();
        ...
        if (!Pass.equals("") && !Pass2.equals("")) {
            ...
            txt_password.setBackground(Color.red);
            txt_passwordConfirmacion.setBackground(Color.red);
            JOptionPane.showMessageDialog(null, "El sistema no admite campos Vacios");
        }
