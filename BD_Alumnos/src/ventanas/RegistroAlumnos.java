...
public class RegistroAlumnos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            //PreparedStatement pst = cn.prepareStatement("insert into alumnos values(?,?,?)");  // otra forma de hacerlo
            PreparedStatement pst = cn.prepareStatement("insert into alumnos (NombreAlumno,Grupo) values ('"+ nombre +"','"+grupo+"')");
           // pst.setString(1, "0");
           // pst.setString(2, txt_nombre.getText().trim());  // otra forma de hacerlo
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
           ...
           label_status.setText("Alumno Eliminado de la BD");
        } catch (Exception e) {
        }
    ...
    private void Boton_PDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Boton_PDFActionPerformed
        ...
        try {
            ...
            parrafo.add("Parrafo creado por Alex \n\n");
            parrafo.setFont(FontFactory.getFont("Tahoma", 20, Font.BOLD, BaseColor.RED));
            ...
            documento.close();
            JOptionPane.showMessageDialog(null, "Reporte Guardado en el Escritorio");
